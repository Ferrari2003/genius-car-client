...
const BannerItem = ({slide}) => {
    ...
    return (
        ...
        <div className="absolute flex justify-end w-1/2 transform -translate-y-1/2 left-20  top-2/4">
        ...
        <div className="absolute flex justify-start w-2/5 transform -translate-y-1/2 left-20  top-3/4">
