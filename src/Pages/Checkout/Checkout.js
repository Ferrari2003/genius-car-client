        ...
        <div>
            <form onSubmit={handlePlaceOrder}>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                    <input name='fistName' type="text" placeholder="Fast Name" className="input input-ghost input-bordered w-full" required />
                    <input name='lastName' type="text" placeholder="Last Name" className="input input-ghost input-bordered w-full" required />
